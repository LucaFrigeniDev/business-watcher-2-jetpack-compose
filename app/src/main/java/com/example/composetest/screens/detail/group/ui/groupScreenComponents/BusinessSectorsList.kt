...
import com.example.composetest.screens.detail.group.domain.GroupBusinessSectorStats
import com.example.composetest.theme.LightGrey
import com.example.composetest.theme.White

@Composable
fun BusinessSectors(businessSectors: List<GroupBusinessSectorStats>) = Column(
    Modifier
        .fillMaxWidth()
...
@Composable
fun BusinessSectorCard(businessSector: GroupBusinessSectorStats) = Card(
    Modifier
        .padding(6.dp)
        .height(200.dp)
        .width(160.dp),
